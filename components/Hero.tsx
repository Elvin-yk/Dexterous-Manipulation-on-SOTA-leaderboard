    ...
    <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-xl md:text-2xl text-slate-300 mb-6">
          A living scoreboard for dexterous hand manipulation research.
        </p>
        <p className="text-slate-400 max-w-3xl mx-auto mb-8">
          Track state-of-the-art performance across Adroit, DexArt, and Bi-DexHands with
          standardized metrics, settings, and reproducibility notes.
        </p>
        <div className="flex justify-center space-x-4 mb-6">
          <Link
            href="/benchmarks/adroit"
